# Trend analysis of long-term CO measurements at Wollongong

# Import data (Dropbox/2016/UOW/HCHO\ Research\ Assistantship/FTIR\ data/co_fts_data.csv)
# Retrieval of CO from Wollongong FTIR from 05/96 - 12-14
co_long<-import(file = file.choose(), file.type = "csv",
...
TheilSen(co_long_cut,pollutant="FTS",deseason="TRUE",slope.percent="TRUE",fontsize=20,
         xlab="Year",ylab=expression(CO ~ (molecs.cm^{-2})),main="CO at Wollongong",
...
# No autocorrelation
TheilSen(co_long_cut,pollutant="FTS",deseason="TRUE",slope.percent="TRUE",type="month",
         fontsize=20,xlab='Year',ylab=expression(CO ~ (molecs.cm^{-2})),lty=1,pch=20,
         main="CO at Wollongong",data.col="black",line.col="blue",lwd=4,cex=0.05)
# Autocorrelation
TheilSen(co_long_cut,pollutant="FTS",deseason="TRUE",slope.percent="TRUE",type="month",
         fontsize=20,xlab='Year',ylab=expression(CO),lty=1,pch=20,
         main="CO at Wollongong (autocor)",data.col="black",line.col="blue",lwd=4,
...
#No Autocorrelation
co_mon_trends$trends <- c(-2.11,-1.67,-2.02,-2.28,-2.08,-2.36,-2.61,-1.94,-1.68,-1.20,-0.13,-2.45)
co_mon_trends$poserr <- c(-1.47,-1.19,-1.54,-2.00,-1.31,-2.10,-2.41,-1.69,-1.29,-0.85,0.34,-1.96)
co_mon_trends$negerr <- c(-3.05,-2.09,-2.48,-2.54,-2.49,-2.64,-2.80,-2.15,-1.92,-1.56,-0.66,-2.86)
#Autocorrelation
co_mon_trends$trends <- c(-2.11,-1.67,-2.02,-2.28,-2.08,-2.36,-2.61,-1.94,-1.68,-1.20,-0.13,-2.45)
co_mon_trends$poserr <- c(-0.63,-0.28,-1.12,-1.24,-0.21,-1.53,-2.14,-1.24,-0.58,-0.45,1.24,-1.45)
co_mon_trends$negerr <- c(-4.21,-2.64,-3.10,-3.09,-2.78,-3.06,-3.20,-2.48,-2.32,-2.10,-1.69,-3.82)
